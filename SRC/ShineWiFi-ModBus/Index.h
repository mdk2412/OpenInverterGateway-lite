...
<body>
    ...
    <h3 style="position: relative; left: 20px;">Charging Power (Limit): <span id="batteryCharge">Loading...</span></h3>
    <h3 style="position: relative; left: 20px;">Discharging Power (Limit): <span id="batteryDischarge">Loading...</span></h3>    
