...
void loop();
#line 154 "/home/dirkm/Dokumente/GitHub/OpenInverterGateway-lite/SRC/ShineWiFi-ModBus/ShineWiFi-ModBus.ino"
void updateRedLed() {
  uint8_t state = 0;
  if (!readoutSucceeded) {
    state = 1;
...
# 204 "/home/dirkm/Dokumente/GitHub/OpenInverterGateway-lite/SRC/ShineWiFi-ModBus/ShineWiFi-ModBus.ino"
void InverterReconnect(void) {
