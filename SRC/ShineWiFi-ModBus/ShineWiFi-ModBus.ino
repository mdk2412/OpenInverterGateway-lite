...
void loadFirst(void) {
    httpServer.send(200, F("text/html"), F("<html><body>Setting priority mode to load first...</body></html>"));
    uint16_t mode_low = 8192;
    uint16_t mode_high = 5947;
    if ((Inverter.WriteHoldingReg(3040, mode_low)) && (Inverter.WriteHoldingReg(3041, mode_high))) {
...
void batteryFirst(void) {
    httpServer.send(200, F("text/html"), F("<html><body>Setting priority mode to battery first...</body></html>"));
...
void gridFirst(void) {
    httpServer.send(200, F("text/html"), F("<html><body>Setting priority mode to grid first...</body></html>"));
