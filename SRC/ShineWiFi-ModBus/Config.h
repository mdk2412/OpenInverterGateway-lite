...
// if SoC <= BDCDischargeStopSOC & PVTotalPower < sleep PV threshold (configure
// in WiFiManager) battery is put to sleep if PVTotalPower > wake PV threshold
...
#define ACCHARGE_TIMER 5000     // 5s default
